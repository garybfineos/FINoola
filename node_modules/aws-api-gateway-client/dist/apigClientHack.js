...
apigClientFactory.newClient = function () {
  ...
  apigClient.invokeApi = function(that, params, pathTemplate, method, additionalParams, body){
    ...
    var serviceResponse = apiGatewayClient.makeRequest(request, authType, additionalParams, config.apiKey);
    var response = {
